...
public class SignUpInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "select year/term", "1/1", "1/2", "2/1", "2/2", "3/1", "3/2", "4/1", "4/2" }));
...
/**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignUpInterface.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
